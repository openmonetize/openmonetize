...
export function Header({ apiKey, balance, onLogout, onTopUp }: HeaderProps) {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950/50 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-2">
              <div
                className={`p-1.5 rounded-full ${balance !== null && balance > 0 ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-red-100 text-red-700"}`}
              >
            ...
            <Button
              size="sm"
              variant="ghost"
              className="h-7 px-2 text-xs hover:bg-white dark:hover:bg-slate-800 rounded-full"
              onClick={onTopUp}
            >
              + Add
            </Button>
